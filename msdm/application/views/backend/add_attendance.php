...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-calendar-check-o"></i> Tambah Kehadiran (Individu)</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Beranda</a></li>
                <li class="breadcrumb-item inactive">Kehadiran</li>
                <li class="breadcrumb-item active">Tambah Kehadiran (Individu)</li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Attendance" class="text-white"><i class="" aria-hidden="true"></i> Daftar Kehadiran</a></button>
            ...
            <div class="col-6">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> <b>Tambah Kehadiran (Individu)</b> </h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="Add_Attendance" id="holidayform" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="m-t-20">Jam Masuk</label>
                                ...
                                <div class="form-group">
                                    <label class="m-t-20">Jam Pulang</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="attendanceUpdate" class="btn btn-success">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
