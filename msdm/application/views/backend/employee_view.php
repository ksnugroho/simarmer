    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item inactive">Daftar Karyawan</li>
                <li class="breadcrumb-item active"><?php echo $basic->first_name . ' ' . $basic->last_name; ?></li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12 col-xlg-12 col-md-12">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs profile-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#home" role="tab" style="font-size: 14px;"> Informasi Pribadi </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#profile" role="tab" style="font-size: 14px;"> Alamat </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#education" role="tab" style="font-size: 14px;"> Pendidikan </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#experience" role="tab" style="font-size: 14px;"> Pengalaman Kerja</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#bank" role="tab" style="font-size: 14px;"> Rekening Bank </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#document" role="tab" style="font-size: 14px;"> Dokumen </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#salary" role="tab" style="font-size: 14px;"> Gaji </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#leave" role="tab" style="font-size: 14px;"> Cuti </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#social" role="tab" style="font-size: 14px;"> Media Sosial </a>
                        </li>
                        <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password" role="tab" style="font-size: 14px;"> Ubah Password</a> </li>
                        <?php } else { ?>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password1" role="tab" style="font-size: 14px;"> Ubah Password</a> </li>
                        <?php } ?>
                    </ul>
                    <!-- Tab panes -->
                    ...
                    <div class="tab-content">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body"> <small class="text-muted">Email </small>
                                                    <h6><?php echo $basic->em_email; ?></h6> <small class="text-muted p-t-30 db">Telepon</small>
                        ...
                        <div class="tab-pane" id="profile" role="tabpanel">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Alamat Sesuai KTP (Domisili)</h3>
                                    <hr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <td class="jsgrid-align-center ">
                                                                ...
                                                                <a onclick="confirm('Apakah Anda yakin ingin menghapus data ini?')" href="#" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light edudelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                                            </td>
                                                        <?php } ?>
                                                    </tr>
                                                <?php endforeach; ?>
