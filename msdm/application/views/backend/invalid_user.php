         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-users" aria-hidden="true"></i> Daftar Karyawan (Tidak Aktif)</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item inactive">Karyawan</li>
                        <li class="breadcrumb-item active">Daftar Karyawan (Tidak Aktif)</li>
                    </ol>
                </div>
            </div>
