...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-money"></i> Slip Gaji Karyawan
      </h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Slip Gaji Karyawan
        </li>
      </ol>
    </div>
  </div>
      ...
      <div class="col-12">
        <div class="card card-outline-info">
          <div class="card-header">
            <h4 class="m-b-0 text-white"> <b>Slip Gaji Karyawan</b>
            </h4>
          </div>
          <div class="card-body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class='input-group date' id=''>
                              <input type='text' name="datetime" class="form-control mydatetimepicker" placeholder="Pilih Bulan" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-3">
                        <button style="float:left;margin-top:23px" type="submit" id="BtnSubmit" class="btn btn-success">Pilih</button>
                      </div>
                    </form>
                  </div>
                </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
          <div class="modal-header">
            <h4 class="modal-title" id="">Pengaturan Gaji Karyawan
            </h4>
