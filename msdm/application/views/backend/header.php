...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="16x16" href="<?php echo base_url(); ?>assets/images/cropped-logo-h-32x32.png">
    <title>SIMARMER | <?php echo $settingsvalue->sitetitle; ?></title>
    <!-- Bootstrap Core CSS -->
...
function formatTanggalIndonesia($tanggal) {
    // Ubah string tanggal ke dalam format DateTime
    ...
    $bulanIndo = $bulan[(int)$tanggal->format('n')];
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>"><i class="ti-user"></i> Profil Saya</a></li>
                                    <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>

                                    <li><a href="<?php echo base_url(); ?>settings/Settings"><i class="ti-settings"></i> Pengaturan Sistem</a></li>
                                    <?php } ?>
                                    <li><a href="<?php echo base_url(); ?>login/logout"><i class="fa fa-power-off"></i> Keluar Aplikasi</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
