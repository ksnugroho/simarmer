         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-money"></i>  Daftar Pembayaran Gaji</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Beranda</a></li>
                        <li class="breadcrumb-item inactive"> Gaji</li>
                        <li class="breadcrumb-item active"> Daftar Pembayaran Gaji</li>
                    </ol>
                </div>
            </div>
...
<!--                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#TypeModal" data-whatever="@getbootstrap" class="text-white TypeModal"><i class="" aria-hidden="true"></i> Add Payroll </a></button>-->
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Payroll/Generate_salary" class="text-white"><i class="" aria-hidden="true"></i>  Tambah Payslip</a></button>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><b>Daftar Pembayaran Gaji </b>                    
                                </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td><?php echo formatRupiah($individual_info->basic); ?></td>
                                                <td><?php echo formatRupiah($individual_info->loan); ?></td>
                                                <td><?php echo $individual_info->total_days; ?></td>
                                                <!--<td><?php echo $individual_info->addition; ?></td>-->
                                                <td><?php echo formatRupiah($individual_info->diduction); ?></td>
                                                <td><?php echo formatRupiah($individual_info->total_pay); ?></td>
