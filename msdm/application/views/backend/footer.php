            ...
            <footer class="footer"> Hak Cipta SIMARMER © <?php echo date('Y')?> | Dikembangkan oleh Tim Peneliti <a href="http://widyagama.ac.id/" target="_blank"> Universitas Widya Gama Malang </a></footer>
