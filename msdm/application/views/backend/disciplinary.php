...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-users" aria-hidden="true"></i> Tindakan Indisipliner</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Beranda</a></li>
                <li class="breadcrumb-item inactive">Karyawan</li>
                <li class="breadcrumb-item active">Tindakan Indisipliner</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        ...
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Tambah Tindakan Indisipliner</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><b>Daftar Tindakan Indisipliner</b></h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <?php foreach ($desciplinary as $value): ?>
                                        <tr>
                                            ...
                                            <td class="jsgrid-align-center ">
                                                ...
                                                <a href="DeletDisiplinary?D=<?php echo $value->id; ?>" onclick="confirm('Apakah Anda yakin ingin menghapus data ini?')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                    ...
                                    <div class="modal-content ">
                                        ...
                                        <form method="post" action="add_Desciplinary" id="btnSubmit" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Tindakan Disiplin</label>
                                                    <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="warning" value="">
                                                        <option>Pilih Tindakan Disiplin</option>
                                                        <option value="Verbel Warning">Peringatan Verbal (SP 1)</option>
                                                        <option value="Writing Warning">Peringatan Tertulis (SP 2)</option>
                                                        <option value="Demotion">Penurunan Jabatan</option>
                                                        <option value="Suspension">Dikeluarkan</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
