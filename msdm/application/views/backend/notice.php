      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-clipboard"></i> Pengumuman</h3>
                </div>
        ...
        <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#noticemodel" data-whatever="@getbootstrap" class="text-white "><i class="" aria-hidden="true"></i> Tambah Pengumuman</a></button>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                    <h4 class="m-b-0 text-white"> <b> Daftar Pengumuman</b></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                           <?php foreach($notice as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo formatTanggalIndonesia($value->date); ?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">Nama Pengumuman/Gambar</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="recipient-name1" class="control-label">Dokumen</label>
