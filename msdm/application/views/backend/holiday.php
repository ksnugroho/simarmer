         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-bullhorn"></i> Hari Libur</h3>
                </div>
...
<!--
                ...
                <div class="row m-b-10"> 
                    ...
                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                        ...
                        <?php } else { ?>
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#holysmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Tambah Hari Libur </a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"> <b>Daftar Hari Libur</b>  </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                           <?php foreach($holidays as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php if(!empty($value->to_date)){ echo formatTanggalIndonesia($value->to_date); } ?></td>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="confirm('Apakah Anda yakin ingin menghapus data ini?')" href="#" title="Delete" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> hidden <?php } ?> class="btn btn-sm btn-danger waves-effect waves-light holidelet" data-id="<?php echo $value->id; ?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                        ...
                        <div class="modal fade" id="holysmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Tambah Hari Libur</h4>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Nama Hari Libur</label>
