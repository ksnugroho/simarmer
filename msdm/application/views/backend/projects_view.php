                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">  Informasi Proyek</a> </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Tanggal Mulai </small>
                                <h6><?php echo $details->pro_start_date; ?></h6> <small class="text-muted p-t-30 db">Tanggal Selesai</small>
