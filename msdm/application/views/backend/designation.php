...
<?php $this->load->view('backend/sidebar'); ?> 
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-building-o"></i> Penugasan (Jabatan)</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Beranda</a></li>
                        <li class="breadcrumb-item inactive">Organisasi</li>
                        <li class="breadcrumb-item active">Penugasan (Jabatan)</li>
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
            ...
            <?php if (isset($editdesignation)) { ?>
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><b>Sunting Penugasan (Jabatan)</b></h4>
                    </div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Nama Penugasan (Jabatan)</label>
                ...
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><b>Tambah Penugasan (Jabatan)</b></h4>
                    </div>
        ...
        <div class="col-7">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> <b>Daftar Penugasan (Jabatan)</b></h4>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        ...
                                        <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"  href="<?php echo base_url();?>organization/des_delete/<?php echo $value->id;?>" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
