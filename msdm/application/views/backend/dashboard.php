...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="mdi mdi-gauge"></i> Dasbor</h3>
        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0"><b>
                                        ...
                                        ?> Karyawan Aktif</b></h3>
                                <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>leave/Application" class="text-muted m-b-0">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0"><b>
                                        <?php
                                        // $this->db->where('ass_id');
                                        $this->db->from("assets");
                                        echo $this->db->count_all_results();
                                        ?> Aset </b>
                                </h3>
                                <a href="<?php echo base_url(); ?>Logistice/All_Assets" class="text-muted m-b-0">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-inverse card-info">
                    <div class="box bg-primary text-center">
                        ...
                        <h6 class="text-white">Karyawan Tidak Aktif</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-inverse card-danger">
                    <div class="box text-center">
                        ...
                        <h6 class="text-white">Proyek Mendatang</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-inverse card-success">
                    <div class="box text-center">
                        <h1 class="font-light text-white">
                            <?php
                            $this->db->where('cat_status', 'Aset Tetap');
                            $this->db->from("assets_category");
                            echo $this->db->count_all_results();
                            ?>
                        </h1>
                        <h6 class="text-white">Kategori Aset Tetap</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><b>Proyek yang Berjalan</b></h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><b>Daftar Tugas</b></h4>
                        <h6 class="card-subtitle">Daftar tugas berikutnya yang harus diselesaikan</h6>
                        ...
                        <div class="new-todo">
                            <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo">
                                <div class="input-group">
                                    <input type="text" name="todo_data" class="form-control" style="border: 1px solid #fff !IMPORTANT;" placeholder="Tambahkan Tugas Baru">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><b>Daftar Pengumuman</b></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($notice as $value): ?>
                                        <tr class="scrollbar" style="vertical-align:top">
                                            ...
                                            <td style="width:100px"><?php echo formatTanggalIndonesia($value->date); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <?php foreach ($holiday as $value): ?>
                                        <tr style="background-color:#e3f0f7">
                                            ...
                                            <td><?php echo formatTanggalIndonesia($value->from_date); ?></td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
                            </table>
